...
namespace ygz
{
          ...
          mbDeactivateLocalizationMode(false)
    {
        ...
        LOG(INFO) << "This is YGZ-SLAM, forked from ORB-SLAM proposed by Raul Mur-Artal, University of Zaragoza." << endl
                  << "This program comes with ABSOLUTELY NO WARRANTY;" << endl
                  << "This is free software, and you are welcome to redistribute it" << endl
                  << "under certain conditions. See ORB-SLAM's LICENSE.txt." << endl
                  << endl;
        ...
        // Load ORB Vocabulary
        LOG(INFO) << endl
                  << "Loading ORB Vocabulary. This should be super fast ..." << endl;
